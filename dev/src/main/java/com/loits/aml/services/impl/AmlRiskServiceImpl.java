...
//            return response;
//        } catch (IOException e) {
//            throw new FXDefaultException("", "Rest Request to " + service + " Failed", e
// .getMessage(), new Date(), HttpStatus.BAD_REQUEST);
//        }
//    }
...
//                                                 serviceUrl, HashMap<String, String>
// parameters, HashMap<String, String> headers, String service) throws
//            FXDefaultException {
//        URIBuilder builder;
//        String url = null;
//        String jsonString = null;
...
//            return list;
//        } else {
//            throw new FXDefaultException("-1", "FAILED_REQUEST", "Service Request Failed to
// "+service, new Date(), HttpStatus.BAD_REQUEST);
//        }
//    }

  public void runRiskCronJob(Boolean calculateCustRisk, String user, String tenent,
  ...
  @Async
  CompletableFuture<?> saveRiskRecord(OverallRisk overallRisk, Long customerRiskId,
  ...
  @Async
  CompletableFuture<?> saveRiskCalculationTime(Long customerId, Timestamp riskCalcOn,
                                               String tenent) {
    return CompletableFuture.runAsync(() -> {
